...
(defn view []
  [:div {:class "flex justify-center w-full h-full overflow-y-auto"}
   [:div {:class "max-w-2xl"}
    [:h1 {:class "p-3 text-2xl"} "Privacy Policy"]
    [:p {:class "p-3 whitespace-pre-line"}
     "Ambito LLC (the “Company”) is committed to maintaining robust privacy protections for its users.  Our Privacy Policy (“Privacy Policy”) is designed to help you understand how we collect, use and safeguard the information you provide to us and to assist you in making informed decisions when using our Service.  

For purposes of this Agreement, “Site” refers to the Company's website, which can be accessed at https://ambito.app or through our mobile application.
...
VII.         CONTACT US
If you have any questions regarding this Privacy Policy or the practices of this Site, please contact us by sending an email to notifications@ambito.app.
Last Updated: This Privacy Policy was last updated on Jan 24, 2023.
"]]])
